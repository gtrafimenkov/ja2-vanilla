...
#define PROFILE_MISC_FLAG3_MERC_MERC_IS_DEAD_AND_QUOTE_SAID \
  0x20  // In the merc site, the merc has died and Speck quote for the dead merc has been said
...
// used when merc starts game on assignment, goes on assignment later, or leaves to go on another
// contract
#define MERC_WORKING_ELSEWHERE -7

// When the merc was fired, they were a POW, make sure they dont show up in AIM, or MERC as
// available
...
typedef enum { MALE = 0, FEMALE } Sexes;

typedef enum { NOT_SEXIST = 0, SOMEWHAT_SEXIST, VERY_SEXIST, GENTLEMAN } SexistLevels;
