...
enum {
  // Quotes 0-9 are generic NPC quotes common to everyone and controlled by the normal NPC Dialogue
  // system.
  // 10
  ...
  // Quotes 28+ are NPC Specific, and are not under direct control of the SKI system.  The get used
  // by .COD files
};
