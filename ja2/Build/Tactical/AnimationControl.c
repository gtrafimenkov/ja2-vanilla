...
ANIMCONTROLTYPE gAnimControl[] = {
    ...
    // WALKING
    {"WALKING", 20, 0, (FLOAT)1.6,
     ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_RAISE_WEAPON | ANIM_VARIABLE_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},
    // Breathing
    {"STANDING", 0, 0, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_RAISE_WEAPON |
         ANIM_VARIABLE_EFFORT | ANIM_BREATH,
     ANIM_STAND, ANIM_STAND, -1},
    // KNEEL DOWN
    {"KNEEL DOWN", 0, 90, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NOMOVE_MARKER | ANIM_STANCECHANGEANIM |
         ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT,
     ANIM_STAND, ANIM_CROUCH, -1},
    // CROUCHING
    {"CROUCHED", 0, 0, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_RAISE_WEAPON | ANIM_NO_EFFORT |
         ANIM_BREATH,
     ANIM_CROUCH, ANIM_CROUCH, -1},
    // KNEEL UP
    {"KNEEL UP", 0, 90, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NOMOVE_MARKER | ANIM_STANCECHANGEANIM |
         ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT,
     ANIM_CROUCH, ANIM_STAND, -1},
    // SWAT
    {"SWAT", 0, 0, (FLOAT)2.2,
     ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},
    // RUN
    {"RUN", 0, 0, (FLOAT)2.6,
     ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_RAISE_WEAPON | ANIM_MODERATE_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},
    // PRONE DOWN
    {"PRONE DOWN", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_STANCECHANGEANIM | ANIM_NOCHANGE_WEAPON |
         ANIM_MIN_EFFORT,
     ANIM_CROUCH, ANIM_PRONE, -1},
    // CRAWL
    {"CRAWL", 0, 0, (FLOAT).8,
     ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_RAISE_WEAPON | ANIM_MODERATE_EFFORT,
     ANIM_PRONE, ANIM_PRONE, -1},
    // PRONE UP
    {"PRONE UP", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_STANCECHANGEANIM | ANIM_NOCHANGE_WEAPON |
         ANIM_MIN_EFFORT,
     ANIM_PRONE, ANIM_CROUCH, -1},
    // PRONE BREATHING
    {"PRONE", 0, 0, (FLOAT)0,
    ...
    // READY_RIFLE_PRONE
    {"READY (R) PRONE", 0, 150, (FLOAT)0,
     ANIM_OK_CHARGE_AP_FOR_TURN | ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING |
         ANIM_RAISE_WEAPON | ANIM_MIN_EFFORT,
     ANIM_PRONE, ANIM_PRONE, -1},

    // AIM_RIFLE_PRONE
    {"AIM (R) PRONE", 0, 250, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FIREREADY | ANIM_FASTTURN | ANIM_RAISE_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_PRONE, ANIM_PRONE, -1},

    // SHOOT_RIFLE_PRONE
    {"SHOOT (R) PRONE", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_FIRE |
         ANIM_RT_NONINTERRUPT,
     ANIM_PRONE, ANIM_PRONE, -1},

    // END_RIFLE_PRONE
    {"END (R) AIM PRONE", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_NOCHANGE_PENDINGCOUNT |
         ANIM_MIN_EFFORT,
     ANIM_PRONE, ANIM_PRONE, -1},

    // DEATH TWITCH ONE
    {"DEATH TWITCH ONE", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE,
     ANIM_PRONE, -1},

    // GENERIC_HIT STANDING
    {"GENERIC HIT STAND", 0, 130, (FLOAT)0,
    ...
    {"FLYBACK HIT w/B", 0, 80, (FLOAT)1.6,
     ANIM_SPECIALMOVE | ANIM_HITSTART | ANIM_HITFINISH | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER |
         ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_IGNORE_AUTOSTANCE,
     ANIM_PRONE, ANIM_PRONE, -1},

    // FLYBACK HIT DEATH
    {"FLYBACK HIT DEATH", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // READY_RIFLE_CROUCH
    {"READY (R) CROUCH", 0, 150, (FLOAT)0,
     ANIM_OK_CHARGE_AP_FOR_TURN | ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING |
         ANIM_RAISE_WEAPON | ANIM_MIN_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // AIM_RIFLE_CROUCH
    {"AIM (R) CROUCH", 0, 250, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FIREREADY | ANIM_FASTTURN | ANIM_RAISE_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // SHOOT_RIFLE_CROUCH
    {"SHOOT (R) CROUCH", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_FIRE |
         ANIM_RT_NONINTERRUPT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // END_RIFLE_CROUCH
    {"END (R) CROUCH", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_NOCHANGE_PENDINGCOUNT |
         ANIM_MIN_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // FALLBACK HIT STANDING
    {"FALLBACK HIT STAND", 0, 130, (FLOAT)1.6,
     ANIM_SPECIALMOVE | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON |
         ANIM_IGNORE_AUTOSTANCE,
     ANIM_STAND, ANIM_PRONE, -1},

    // ROLLOVER
    {"ROOLOVER", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    // CLIMBROOF
    {"CLIMBROOF", 0, 30, (FLOAT)0,
    ...
    // GETUP FROM ROLLOVER
    {"GETUP FROM ROLLOVER", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_STAND, -1},

    // CLIMBDOWNROOF
    {"CLIMBDOWNROOF", 0, 30, (FLOAT)0,
     ANIM_NONINTERRUPT | ANIM_NORESTART | ANIM_STATIONARY | ANIM_NOSHOW_MARKER |
         ANIM_MODERATE_EFFORT | ANIM_LOWER_WEAPON,
     ANIM_CROUCH, ANIM_STAND, -1},

    // FALL FORWARD
    {"FALL FORWARD ROOF", 0, 60, (FLOAT)0,
     ANIM_NONINTERRUPT | ANIM_STATIONARY | ANIM_HITFINISH | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON | ANIM_IGNORE_AUTOSTANCE,
     ANIM_STAND, ANIM_PRONE, -1},

    // GENERIC HIT DEATHTWICH NO BLOOD
    {"BELLY DEATHHIT NB", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // GENERIC HIT DEATHTWICH BLOOD
    {"BELLY DEATHHIT B", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // FALLBACK HIT DEATHTWICH NO BLOOD
    {"FALLBACK DEATHHIT NB", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // FALLBACK HIT DEATHTWICH BLOOD
    {"FALLBACK DEATHHIT B", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // GENERIC HIT DEATH
    {"BELLY HIT DEATH", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE,
     ANIM_PRONE, -1},

    // FALLBACK HIT DEATH
    {"FALLBACK HIT DEATH", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE,
     ANIM_PRONE, -1},

    // GENERIC HIT CROUCHED
    {"GENERIC HIT CROUCH", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // STAND BURST
    {"STAND BURST SHOOT", 0, 100, (FLOAT)0,
     ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT |
         ANIM_NOCHANGE_WEAPON | ANIM_FIRE,
     ANIM_STAND, ANIM_STAND, -1},

    // STANDING BURST HIT
    {"STAND BUTST HIT", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON |
         ANIM_IGNORE_AUTOSTANCE,
     ANIM_STAND, ANIM_STAND, -1},

    // FALL FORWARD FROM HIT STAND
    {"FALL FROM STAND", 0, 120, (FLOAT)0,
    ...
    {"FALL FROM CROUCH", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
         ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_CROUCH, ANIM_PRONE, -1},

    // END FALL FORWARD FROM HIT CROUCH
    {"END FALL F CROUCH", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // GENERIC HIT PRONE
    {"GENERIC HIT PRONE", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // PRONE HIT DEATH
    {"PRONE HIT DEATH", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // PRONE LAY FROM HIT
    {"PRONE LAY FROM HIT", 0, 160, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // PRONE HIT DEATHTWICH NO BLOOD
    {"PRONE DEATHHIT NB", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // PRONE HIT DEATHTWICH BLOOD
    {"PRONE DEATHHIT B", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // FEMALE MONSTER BREATHING
    {"FEMADMON BREATHING", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // FEMALE MONSTER BREATHING
    {"FEMADMON WALKING", 0, 30, (FLOAT)2.5,
     ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // FEMALE MONSTER ATTACK
    {"FEMADMON ATTACK", 0, 70, (FLOAT)2.5,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    {"FLYBACK HIT DEATH STOP", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    {"BELLY HIT DEATH STOP", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    {"FALLBACK HIT DEATH STOP", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    {"PRONE HIT DEATH STOP", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    {"FLYBACK HIT STOP", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    {"FALLBACK HIT STOP", 0, 350, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    {"FALLOFF STOP", 0, 350, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    {"FALLOFF FORWARD HIT STOP", 0, 350, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    {"FALLFORWARD HIT STOP", 0, 650, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    {"PRONE_LAYFROMHIT STOP", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    {"HOP FENCE", 0, 50, (FLOAT)0,
    ...
    // GENERIC HIT CROUCHED
    {"FEMMONS HIT", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // FALL FORWARD FROM HIT STAND
    {"FEMMONS DIE", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
         ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_PRONE, -1},

    // FALL FORWARD FROM HIT STAND
    {"FEMMONS DIE STOP", 0, 350, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    // Breathing
    {"PUNCH BREATH", 0, 150, (FLOAT)0,
    ...
    // Punch
    {"PUNCH", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_NORESTART,
     ANIM_STAND, ANIM_STAND, -1},

    // Breathing
    {"NOTHING_STAND", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // JFK HIT DEATH
    {"JFK HIT DEATH", 0, 160, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_HITSTART | ANIM_HITFINISH | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_PRONE, -1},

    {"JFK HIT DEATH STOP", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    {"JFK DEATHHIT B", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // STAND BURST
    {"STAND BURST SPREAD", 0, 100, (FLOAT)0, ANIM_STATIONARY | ANIM_TURNING | ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // FALLOFF DEATH
    {"FALLOFF DEATH", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE,
     ANIM_PRONE, -1},

    // FALLOFF DEATH STOP
    {"FALLOFF DEATH STOP", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    // FALLOFF TWITCHB
    {"FALLOFF TWITCH BLOOD", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // FALLOFF TWITCH NB
    {"FALLOFF TWITCH NOBLOOD", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // FALLOFF FORWARD DEATH
    {"FALLOFF FORWARD DEATH", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE,
     ANIM_PRONE, -1},

    // FALLOFF FORWARD DEATH STOP
    {"FALLOFF FORWARD DEATH STOP", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    // FALLOFF FORWARD TWITCHB
    {"FALLOFF FORWARD TWITCH BLOOD", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // FALLOFF TWITCH NB
    {"FALLOFF FORWARD TWITCH NOBLOOD", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // OPEN DOOR
    {"OPEN DOOR", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // OPEN STRUCT
    {"OPEN STRUCT", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // OPEN STRUCT
    {"PICKUP ITEM", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // DROP ITEM
    {"DROP ITEM", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},
    ...
    // CROUCH STAB
    {"CROUCH STAB", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // START GIVING AID
    {"START AID", 0, 90, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
         ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // GIVING AID
    {"GIVING AID", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // END GIVING AID
    {"END AID", 0, 90, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_RAISE_WEAPON |
         ANIM_NO_EFFORT | ANIM_NOCHANGE_PENDINGCOUNT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // DODGE ONE
    {"DODGE ONE", 0, 40, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // FATCIV_ASSSCRATCH
    {"FATCIV ASS SCRATCH", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NO_EFFORT, ANIM_STAND,
     ANIM_STAND, -1},

    // READY_RIFLE_STAND
    {"READY AIM (DW) STAND", 0, 150, (FLOAT)0,
     ANIM_OK_CHARGE_AP_FOR_TURN | ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN |
         ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // AIM_RIFLE_STAND
    {"AIM (DW) STAND", 0, 250, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FIREREADY | ANIM_FASTTURN | ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // SHOOT_RIFLE_STAND
    {"SHOOT (DW) STAND", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_LIGHT_EFFORT | ANIM_FIRE, ANIM_STAND, ANIM_STAND, -1},

    // END_RIFLE_STAND
    {"END DUAL STAND", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NOCHANGE_PENDINGCOUNT | ANIM_LIGHT_EFFORT, ANIM_STAND,
     ANIM_STAND, -1},

    // RAISE RIFLE
    {"RAISE RIFLE", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, ANIM_STAND,
     ANIM_STAND, -1},

    // LOWER RIFLE
    {"LOWER RIFLE", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, ANIM_STAND,
     ANIM_STAND, -1},

    // BOD BLOW
    {"BOD BLOW", 0, 200, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_NO_EFFORT | ANIM_NONINTERRUPT |
         ANIM_NOCHANGE_WEAPON | ANIM_IGNORE_AUTOSTANCE,
     ANIM_STAND, ANIM_STAND, -1},

    // THROW ITEM
    {"THROW ITEM", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_NONINTERRUPT | ANIM_MIN_EFFORT, ANIM_STAND,
     ANIM_STAND, -1},

    // LOB ITEM
    {"LOB ITEM", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_NONINTERRUPT | ANIM_MIN_EFFORT, ANIM_STAND,
     ANIM_STAND, -1},

    // QUEEN MONSTER STATIONARY
    {"MONSTER_STATIONARY", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_NO_EFFORT | ANIM_BREATH, ANIM_STAND, ANIM_STAND,
     -1},

    // CROUCHED BURST
    {"CROUCHED BURST SHOOT", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_LIGHT_EFFORT | ANIM_FIRE, ANIM_CROUCH, ANIM_CROUCH, -1},

    // PRONE BURST
    {"PRONE BURST SHOOT", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_LIGHT_EFFORT | ANIM_FIRE, ANIM_PRONE, ANIM_PRONE, -1},
    // 180
    {"NOT USED 1", 20, 20, (FLOAT)0.9, ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // BIG GUY FLEX
    {"BIG GUY FLEX", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NO_EFFORT, ANIM_STAND, ANIM_STAND, -1},

    // BIG GUY STRECH
    {"BIG GUY STRECH", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NO_EFFORT, ANIM_STAND, ANIM_STAND, -1},

    // BIG GUY SOEDUST
    {"BIG GUY SHOE DUST", 0, 90, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // BIG GUY HEADTURN
    {"BIG GUY HEAD TURN", 0, 180, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // MINI GIRL STOCKING
    {"MINI GIRL STOCKING", 0, 120, (FLOAT)0, ANIM_STATIONARY | ANIM_TURNING | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // GIVE ITEM
    {"GIVE ITEM", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // CLIMB MOUNTIAIN
    {"CLIMB MOUNTAIN", 0, 50, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NOSHOW_MARKER |
         ANIM_MODERATE_EFFORT,
     ANIM_STAND, ANIM_CROUCH, -1},

    {"COW EATING", 0, 200, (FLOAT)0.0, ANIM_STATIONARY | ANIM_TURNING | ANIM_NO_EFFORT, ANIM_STAND,
     ANIM_STAND, -1},

    // COW HIT
    {"COW HIT", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // COW DIE
    {"COW DIE", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
         ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_PRONE, -1},

    // COW DIE STOP
    {"COW DIE STOP", 0, 350, (FLOAT)0, ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT, ANIM_PRONE,
     ANIM_PRONE, -1},

    // WATER HIT
    {"WATER HIT", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // WATER DIE
    {"WATER DIE", 0, 160, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
         ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_PRONE, -1},

    // WATER DIE STOP
    {"WATER DIE STOP", 0, 340, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    {"CROW WALK", 0, 80, (FLOAT)1.6,
     ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT, ANIM_STAND, ANIM_STAND, -1},

    {"CROW TAKEOFF", 0, 80, (FLOAT)1.6,
     ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT, ANIM_STAND, ANIM_STAND, -1},

    {"CROW LAND", 0, 80, (FLOAT)1.6, ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    {"CROW FLY", 0, 20, (FLOAT)0.5,
     ANIM_SPECIALMOVE | ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT, ANIM_STAND,
     ANIM_STAND, -1},

    {"CROW EAT", 0, 80, (FLOAT)0, ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_MIN_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    {"HELIDROP", 0, 60, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_CROUCH, -1},

    {"FEM CLEAN", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    {"FEM KICKSN", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    {"FEM LOOK", 0, 180, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    {"FEM WIPE", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    {"REG SQUISH", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    {"REG PULL", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    {"REG SPIT", 0, 130, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    {"KID YOYO", 0, 140, (FLOAT)0, ANIM_STATIONARY | ANIM_TURNING | ANIM_NO_EFFORT, ANIM_STAND,
     ANIM_STAND, -1},

    {"KID ARMPIT", 0, 70, (FLOAT)0, ANIM_STATIONARY | ANIM_TURNING | ANIM_NO_EFFORT, ANIM_STAND,
     ANIM_STAND, -1},

    {"ADULT MONSTER CLOSE ATTACK", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_LIGHT_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    {"ADULT MONSTER SPIT ATTACK", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_LIGHT_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    {"ADULT MONSTER BEGIN EATING", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    {"ADULT MONSTER EATING", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT, ANIM_STAND, ANIM_STAND,
     -1},

    {"ADULT MONSTER END EATING", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // RUN
    {"BLOODCAT RUN", 0, 50, (FLOAT)5.4,
     ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_MODERATE_EFFORT, ANIM_STAND, ANIM_STAND,
     -1},

    //
    {"BLOODCAT BEGIN READY", 0, 70, (FLOAT)0,
     ANIM_OK_CHARGE_AP_FOR_TURN | ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    {"BLOODCAT READY", 0, 130, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT, ANIM_STAND, ANIM_STAND, -1},

    {"BLOODCAT END READY", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT, ANIM_STAND, ANIM_STAND, -1},

    // CAT HIT
    {"BLOODCAT HIT", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // CAT DIE
    {"BLOODCAT DIE", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER,
     ANIM_STAND, ANIM_PRONE, -1},

    // CAT DIE STOP
    {"BLOODCAT DIE STOP", 0, 100, (FLOAT)0, ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT,
     ANIM_PRONE, ANIM_PRONE, -1},

    {"BLOODCAT SWIPE", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_MIN_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    {"NINJA GOTO BREATH", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
         ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    {"NINJA BREATH", 0, 0, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_STAND,
     ANIM_STAND, -1},

    {"NINJA LOWKICK", 0, 50, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON |
         ANIM_NORESTART,
     ANIM_STAND, ANIM_STAND, -1},

    {"NINJA PUNCH", 0, 50, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON |
         ANIM_NORESTART,
     ANIM_STAND, ANIM_STAND, -1},

    {"NINJA SPIN KICK", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_MODERATE_EFFORT |
         ANIM_NOCHANGE_WEAPON | ANIM_NORESTART,
     ANIM_STAND, ANIM_STAND, -1},

    // END OPEN DOOR
    {"END OPEN DOOR", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_MIN_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // END OPEN LOCKED DOOR
    {"END OPEN LOCKED DOOR", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
         ANIM_LOWER_WEAPON | ANIM_MIN_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // KICK DOOR
    {"KICK DOOR", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // KICK DOOR
    {"CLOSE DOOR", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_MIN_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // HIT STANDING RIFLE
    {"HIT STAND RIFLE", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTART | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_NOCHANGE_WEAPON |
         ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // DEEP WATER TREAD
    {"DEEP WATER TREAD", 0, 200, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NOCHANGE_WEAPON | ANIM_MODERATE_EFFORT, ANIM_STAND,
     ANIM_STAND, -1},

    // DEEP WATER SWIM
    {"DEEP WATER SWIM", 0, 160, (FLOAT)1.3,
     ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_NOCHANGE_WEAPON | ANIM_MODERATE_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // DEEP WATER HIT
    {"DEEP WATER HIT", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // DEEP WATER DIE
    {"DEEP WATER DIE", 0, 210, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
         ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_PRONE, -1},

    // DEEP WATER DIE STOPPING
    {"DEEP WATER DIE STOPPING", 0, 340, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    // DEEP WATER DIE STOP
    {"DEEP WATER DIE STOP", 0, 340, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    // WATER TRANSITION
    {"LOW TO DEEP WATER", 0, 100, (FLOAT)0, ANIM_STATIONARY | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // WATER TRANSITION
    {"DEEP TO LOW WATER", 0, 100, (FLOAT)0, ANIM_STATIONARY | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // GOTO SLEEP
    {"GOTO SLEEP", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_LOWER_WEAPON | ANIM_NONINTERRUPT | ANIM_NO_EFFORT, ANIM_CROUCH,
     ANIM_PRONE, -1},

    // SLEEP
    {"SLEEPING", 0, 2000, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT | ANIM_UPDATEMOVEMENTMODE, ANIM_PRONE,
     ANIM_PRONE, -1},

    // WAKEUP
    {"WAKEUP", 0, 100, (FLOAT)0, ANIM_STATIONARY | ANIM_RAISE_WEAPON | ANIM_NO_EFFORT, ANIM_PRONE,
     ANIM_CROUCH, -1},

    // SHOOT_RIFLE_STAND LOW
    {"SHOOT (R) STAND LOW", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_FIRE, ANIM_STAND,
     ANIM_STAND, -1},

    // SHOOT_RIFLE_STAND LOW
    {"BURST SHOOT (R) STAND LOW", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_FIRE, ANIM_STAND,
     ANIM_STAND, -1},

    // LARVAE Breathing
    {"LARVAE BREATH", 0, 250, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // GENERIC HIT CROUCHED
    {"LARVAE HIT", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // FALL FORWARD FROM HIT STAND
    {"LARVAE DIE", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
         ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_PRONE, -1},

    // FALL FORWARD FROM HIT STAND
    {"LARVAE DIE STOP", 0, 350, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    // FEMALE MONSTER BREATHING
    {"LARVAE WALKING", 0, 110, (FLOAT)0.5,
     ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // GENERIC HIT CROUCHED
    {"INFANT HIT", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // FALL FORWARD FROM HIT STAND
    {"INFANT DIE", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
         ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_PRONE, -1},

    // FALL FORWARD FROM HIT STAND
    {"INFANT DIE STOP", 0, 350, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    {"INFANT MONSTER SPIT ATTACK", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_LIGHT_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    {"INFANT MONSTER BEGIN EATING", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    {"INFANT MONSTER EATING", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    {"INFANT MONSTER END EATING", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    {"ADULT MONSTER UP", 0, 130, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    {"ADULT MONSTER JUMP", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // UNJAM STANDING
    {"UNJAM STANDING", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // UNJAM CROUCH
    {"UNJAM CROUCH", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // UNJAM PRONE
    {"UNJAM PRONE", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT,
     ANIM_PRONE, ANIM_PRONE, -1},

    // UNJAM STAND DWEL
    {"UNJAM STAND DWEL", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // UNJAM STAND LOW
    {"UNJAM STAND LOW", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // READY_RIFLE_CROUCH
    {"READY AIM (DW) CROUCH", 0, 150, (FLOAT)0,
     ANIM_OK_CHARGE_AP_FOR_TURN | ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN |
         ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // AIM_RIFLE_CROUCH
    {"AIM (DW) CROUCH", 0, 250, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FIREREADY | ANIM_FASTTURN | ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // SHOOT_RIFLE_CROUCH
    {"SHOOT (DW) CROUCH", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_LIGHT_EFFORT | ANIM_FIRE, ANIM_CROUCH, ANIM_CROUCH, -1},

    // END_RIFLE_STAND
    {"END DUAL CROUCH", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NOCHANGE_PENDINGCOUNT | ANIM_LIGHT_EFFORT, ANIM_CROUCH,
     ANIM_CROUCH, -1},

    // UNJAM CROUCH DWEL
    {"UNJAM CROUCH DWEL", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // GET ADJACENT ITEM
    {"GET ADJACENT ITEM", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // CUTTING FENCE
    {"CUTTING FENCE", 0, 90, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
         ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    {"CRIPPLE BEG", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // CRIPPLE HIT
    {"CRIPPLE HIT", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // CRIPPLE DIE
    {"CRIPPLE DIE", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
         ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_PRONE, -1},

    // CRIPPLE DIE STOP
    {"CRIPPLE DIE STOP", 0, 350, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    // CRIPPLE FLYBACK DIE
    {"CRIPPLE FLYBACK DIE", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
         ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_PRONE, -1},

    // CRIPPLE FLYBACK DIE STOP
    {"CRIPPLE FLYBACK DIE STOP", 0, 350, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    // CRIPPLE KICK
    {"CRIPPLE KICK", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_NOMOVE_MARKER | ANIM_MIN_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // INJURED TRANSITION
    {"INJURED TRANSITION", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_NOMOVE_MARKER | ANIM_MIN_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // THROW KNIFE
    {"THROW KNIFE", 0, 50, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_NONINTERRUPT | ANIM_MIN_EFFORT, ANIM_STAND,
     ANIM_STAND, -1},

    // Breathing
    {"KNIFE BREATH", 0, 150, (FLOAT)0,
     ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART |
         ANIM_FIREREADY | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // Breathing
    {"KNIFE GOTO BREATH", 0, 150, (FLOAT)0,
    ...
    // Breathing
    {"KNIFE END BREATH", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_FIREREADY |
         ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_NONINTERRUPT,
     ANIM_STAND, ANIM_STAND, -1},

    // ROBOT HIT
    {"ROBOT HIT", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // ROBOT DIE
    {"ROBOT DIE", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
         ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_PRONE, -1},

    // ROBOT DIE STOP
    {"ROBOT DIE STOP", 0, 350, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    // Catch Standing
    {"Catch Standing", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_FIREREADY |
         ANIM_LIGHT_EFFORT | ANIM_LOWER_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // Catch Crouched
    {"Catch Crouched", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_FIREREADY |
         ANIM_LIGHT_EFFORT | ANIM_LOWER_WEAPON,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // PLANT BOMB
    {"PLANT BOMB", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // Use remote
    {"Use Remote", 0, 80, (FLOAT)0,
     ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART |
         ANIM_FIREREADY | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_NONINTERRUPT,
     ANIM_STAND, ANIM_STAND, -1},

    // COWER
    {"START Cower", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_FIREREADY |
         ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_NONINTERRUPT | ANIM_IGNORE_AUTOSTANCE,
     ANIM_STAND, ANIM_CROUCH, -1},

    // COWER
    {"Cowering", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_FIREREADY |
         ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_IGNORE_AUTOSTANCE,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // END COWER
    {"End Cower", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_FIREREADY |
         ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_IGNORE_AUTOSTANCE,
     ANIM_CROUCH, ANIM_STAND, -1},

    // STEAL ITEM
    {"STEAL ITEM", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // LAUNCH ROCKET
    {"LAUNCH ROCKET", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // CIV ALT DIE
    {"CIV ALT DIE", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
         ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_PRONE, -1},

    // SHOOT MORTAR
    {"SHOOT MORTAR", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // CROW DIE
    {"CROW_DIE", 0, 130, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NOCHANGE_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // SIDE STEPPING
    {"SIDE STEPPING", 0, 50, (FLOAT)0.4,
     ANIM_MOVING | ANIM_NORESTART | ANIM_RAISE_WEAPON | ANIM_VARIABLE_EFFORT, ANIM_STAND,
     ANIM_STAND, -1},

    // WALK BACKWARDS
    {"WALK BACKWARDS", 0, 110, (FLOAT)1.4,
     ANIM_MOVING | ANIM_NORESTART | ANIM_RAISE_WEAPON | ANIM_VARIABLE_EFFORT | ANIM_TURNING,
     ANIM_STAND, ANIM_STAND, -1},

    // OPEN STRUCT
    {"BEGIN OPEN STRUCT", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
         ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // END STRUCT
    {"END OPEN STRUCT", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
         ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // END OPEN LOCKED
    {"END OPEN LOCKED STRUCT", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
         ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // Punch LOw
    {"LOW PUNCH", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_CROUCH,
     ANIM_CROUCH, -1},

    // SHOOT_PISTOL_STAND LOW
    {"SHOOT (P) STAND LOW", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_FIRE, ANIM_STAND,
     ANIM_STAND, -1},

    // DECAPITATE
    {"DECAPITATE", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT |
         ANIM_NONINTERRUPT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    {"BLOODCAT BITE", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_MIN_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    {"BIGMERC S NECK", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // CROUCH TRANSITION
    {"BIGMERC CROUCH TRANS INTO", 0, 90, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NOMOVE_MARKER | ANIM_STANCECHANGEANIM |
         ANIM_RAISE_WEAPON | ANIM_MIN_EFFORT,
     ANIM_STAND, ANIM_CROUCH, -1},

    // CROUCH TRANSITION
    {"BIGMERC CROUCH TRANS OUTOF", 0, 90, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NOMOVE_MARKER | ANIM_STANCECHANGEANIM |
         ANIM_RAISE_WEAPON | ANIM_MIN_EFFORT,
     ANIM_CROUCH, ANIM_STAND, -1},

    // GOTO PATIENT
    {"GOTO PATIENT", 0, 1000, (FLOAT)0,
     ANIM_STATIONARY | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, ANIM_PRONE,
     ANIM_PRONE, -1},

    // BEING PATIENT
    {"BEING PATIENT", 0, 1000, (FLOAT)0,
     ANIM_STATIONARY | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT |
         ANIM_UPDATEMOVEMENTMODE,
     ANIM_PRONE, ANIM_PRONE, -1},

    // GOTO DOCTOR
    {"GOTO DOCTOR", 0, 90, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
         ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // BEING DOCTOR
    {"BEING DOCTOR", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT |
         ANIM_UPDATEMOVEMENTMODE,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // ENDING DOCTOR
    {"END DOCTOR", 0, 90, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_RAISE_WEAPON |
         ANIM_NO_EFFORT | ANIM_NOCHANGE_PENDINGCOUNT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // GOTO REPAIRMAN
    {"GOTO REPAIRMAN", 0, 90, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
         ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // BEING REPAIRMAN
    {"BEING REPAIRMAN", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT |
         ANIM_UPDATEMOVEMENTMODE,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // ENDING REPAIRMAN
    {"END REPAIRMAN", 0, 90, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_RAISE_WEAPON |
         ANIM_NO_EFFORT | ANIM_NOCHANGE_PENDINGCOUNT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // FALL INTO PIT
    {"FALL INTO PIT", 0, 60, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_PRONE, -1},

    // ROBOT WALK
    {"ROBOT WALKING", 0, 80 / 2, (FLOAT)1.5,
     ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // ROBOT SHOOT
    {"ROBOT SHOOT", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_FIRE, ANIM_STAND,
     ANIM_STAND, -1},

    // QUEEN HIT
    {"QUEEN HIT", 0, 200, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // QUEEN DIE
    {"QUEEN DIE", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_HITFINISH | ANIM_NOMOVE_MARKER | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_PRONE, -1},

    // QUEEN DIE STOP
    {"QUEEN DIE STOP", 0, 350, (FLOAT)0,
     ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, ANIM_PRONE, ANIM_PRONE,
     -1},

    {"QUEEN INTO READY", 0, 130, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT, ANIM_STAND, ANIM_STAND, -1},

    {"QUEEN READY", 0, 130, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT, ANIM_STAND, ANIM_STAND, -1},

    {"QUEEN END READY", 0, 130, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT, ANIM_STAND, ANIM_STAND, -1},

    {"QUEEN CALL", 0, 130, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT, ANIM_STAND, ANIM_STAND, -1},

    {"QUEEN MONSTER SPIT ATTACK", 0, 130, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_LIGHT_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    {"QUEEN MONSTER SWIPE ATTACK", 0, 130, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_LIGHT_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // RELOAD ROBOT
    {"RELOAD ROBOT", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
         ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},
    ...
    {"RADIO", 0, 130 / 130, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT, ANIM_STAND, ANIM_STAND, -1},

    {"CROUCH RADIO", 0, 130 / 130, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT, ANIM_CROUCH, ANIM_CROUCH,
     -1},

    // TANK SHOOT
    {"TANK SHOOT", 0, 200, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NOCHANGE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_FIRE,
     ANIM_STAND, ANIM_STAND, -1},

    // TANK SHOOT
    {"TANK BURST", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NOCHANGE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_FIRE,
     ANIM_STAND, ANIM_STAND, -1},

    // Queen Slap
    {"QUEEN SLAP", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // Slap hit
    {"SLAP HIT", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // GET BLOOD
    {"GET BLOOD", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
         ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // VEHICLE DIE
    {"VEHICLE DIE", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
         ANIM_NOCHANGE_WEAPON | ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // Queen Frustrated Slap
    {"QUEEN FRUSTRATED SLAP", 0, 120, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT |
         ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // SOLDIER BRUN
    {"FIRE FIRE", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
         ANIM_NOCHANGE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_IGNORE_AUTOSTANCE,
     ANIM_STAND, ANIM_STAND, -1},

    // AI TRIGGER
    {"AI TRIGGER", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // MONSTER MELT
    {"MONSTERMELT", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
         ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_PRONE, ANIM_PRONE, -1},

    {"MERC INJURED IDLE ANIM", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // INJURED TRANSITION
    {"END INJURED WALK", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NOMOVE_MARKER | ANIM_MIN_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // PASS OBJECT
    {"PASS OBJECT", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // ADJACENT DROP OBJECT
    {"ADJACENT DROP OBJECT", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // READY_RIFLE_PRONE
    {"READY AIM (DW) PRONE", 0, 150, (FLOAT)0,
     ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_LIGHT_EFFORT,
     ANIM_PRONE, ANIM_PRONE, -1},

    // AIM_RIFLE_PRONE
    {"AIM (DW) PRONE", 0, 250, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FIREREADY | ANIM_FASTTURN | ANIM_LIGHT_EFFORT,
     ANIM_PRONE, ANIM_PRONE, -1},

    // SHOOT_RIFLE_PRONE
    {"SHOOT (DW) PRONE", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_LIGHT_EFFORT | ANIM_FIRE, ANIM_PRONE, ANIM_PRONE, -1},

    // END_RIFLE_PRONE
    {"END DUAL PRONE", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NOCHANGE_PENDINGCOUNT | ANIM_LIGHT_EFFORT, ANIM_PRONE,
     ANIM_PRONE, -1},

    // UNJAM PRONE DWEL
    {"UNJAM PRONE DWEL", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT,
     ANIM_PRONE, ANIM_PRONE, -1},

    // PICK LOCK
    {"PICK LOCK", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // OPEN DOOR CROUCHED
    {"OPEN DOOR CROUCHED", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // BEGIN OPENSTRUCT CROUCHED
    {"BEGIN OPEN STRUCT CROUCHED", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // CLOSE DOOR CROUCHED
    {"CLOSE DOOR CROUCHED", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // OPEN STRUCT CROUCHED
    {"OPEN STRUCT CROUCHED", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // END OPEN DOOR CROUCHED
    {"END OPEN DOOR CROUCHED", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // END OPENSTRUCT CROUCHED
    {"END OPENSTRUCT CROUCHED", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // END OPEN LOCKED DOOR CROUCHED
    {"END OPNE LOCKED DOOR CR", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // END OPEN STRUCT LOCKED CR
    {"END OPEN STRUCT LOCKED CR", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
         ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    {"DRUNK IDLE", 0, 170, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // CROWBAR
    {"CROWBAR", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_NORESTART,
     ANIM_STAND, ANIM_STAND, -1},

    // COWER HIT ANIMATION
    {"COWER HIT", 0, 80, (FLOAT)1.6,
     ANIM_HITSTART | ANIM_HITFINISH | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
         ANIM_NOCHANGE_WEAPON | ANIM_IGNORE_AUTOSTANCE,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // BLOODCAT WALK BACKWARDS
    {"BLOODCAT WALKING BACKWARDS", 0, 30, (FLOAT)1.2,
     ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // CREATURE WALK BACKWARDS
    {"MONSTER WALKING BACKWARDS", 0, 30, (FLOAT)2.5,
     ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},

    // KID SKIPPING
    {"KID SKIPPING", 0, 70, (FLOAT)2.0,
     ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON,
     ANIM_STAND, ANIM_STAND, -1},
    ...
    // Attach string
    {"Attach String", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
         ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // SWAT BACKWARDS
    {"SWAT BACKWARDS", 0, 110, (FLOAT)1.4,
     ANIM_MOVING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_TURNING, ANIM_CROUCH, ANIM_CROUCH, -1},

    // JUMP OVER BLOCKING PERSON
    {"JUMP OVER", 0, 110, (FLOAT)3.6,
     ANIM_SPECIALMOVE | ANIM_NORESTART | ANIM_LOWER_WEAPON | ANIM_MODERATE_EFFORT | ANIM_TURNING,
     ANIM_STAND, ANIM_STAND, -1},

    // REFUEL VEHICLE
    {"REFUEL VEHICLE", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
         ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // Robot camera not moving
    {"ROBOT CAMERA", 0, 0, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_RAISE_WEAPON |
         ANIM_VARIABLE_EFFORT | ANIM_BREATH,
     ANIM_STAND, ANIM_STAND, -1},

    // CRIPPLE OPEN DOOR
    {"CRIPPLE OPEN DOOR", 0, 70, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT,
     ANIM_STAND, ANIM_STAND, -1},

    // CRIPPLE CLOSE DOOR
    {"CRIPPLE CLOSE DOOR", 0, 100, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_MIN_EFFORT, ANIM_STAND,
     ANIM_STAND, -1},
    ...
    // THROW ITEM CROUCHED
    {"THROW ITEM CROUCHED", 0, 80, (FLOAT)0,
     ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_NONINTERRUPT | ANIM_MIN_EFFORT, ANIM_CROUCH,
     ANIM_CROUCH, -1},

    // ROLL PRONE LEFT
    {"ROLL PRONE LEFT", 0, 80, (FLOAT)0.8 /*1.1*/,
     ANIM_MOVING | ANIM_NORESTART | ANIM_RAISE_WEAPON | ANIM_VARIABLE_EFFORT, ANIM_PRONE,
     ANIM_PRONE, -1},

    // ROLL PRONE RIGHT
    {"ROLL PRONE RIGHT", 0, 80, (FLOAT)0.8 /*1.1*/,
     ANIM_MOVING | ANIM_NORESTART | ANIM_RAISE_WEAPON | ANIM_VARIABLE_EFFORT, ANIM_PRONE,
     ANIM_PRONE, -1},

    //***17.12.2008***
    // LAUNCH ROCKET CROUCHED
    {"LAUNCH ROCKET CROUCHED", 0, 110, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    //***11.01.2011*** станковый пулемёт
    // READY_HEAVY_MG
    {"READY HEAVY MG", 0, 150, (FLOAT)0,
     ANIM_OK_CHARGE_AP_FOR_TURN | ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN |
         ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // AIM_HEAVY_MG
    {"AIM HEAVY MG", 0, 250, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_FIREREADY | ANIM_FASTTURN | ANIM_LIGHT_EFFORT,
     ANIM_CROUCH, ANIM_CROUCH, -1},

    // SHOOT_HEAVY_MG
    {"SHOOT HEAVY MG", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_LIGHT_EFFORT | ANIM_FIRE, ANIM_CROUCH, ANIM_CROUCH, -1},

    // END_HEAVY_MG
    {"END HEAVY MG", 0, 150, (FLOAT)0,
     ANIM_STATIONARY | ANIM_TURNING | ANIM_NOCHANGE_PENDINGCOUNT | ANIM_LIGHT_EFFORT, ANIM_CROUCH,
     ANIM_CROUCH, -1},
...
ANI_SPEED_DEF gubAnimWalkSpeeds[TOTALBODYTYPES] = {
    ...
    //***4.11.2007*** скорость робота
    0, (FLOAT)4.0,    // ROBOT1 было 20, (FLOAT)1.1,
    -10, (FLOAT)4.0,  // HUMVEE
...
UINT8 gubMaxActionPoints[TOTALBODYTYPES] = {
    ...
    //***4.11.2007*** АР робота как у машин
    AP_VEHICLE_MAXIMUM,  // ROBOT1 было AP_MAXIMUM,
...
void InitAnimationSurfacesPerBodytype() {
  ...
  //***07.12.2008*** две новые анимации
  gubAnimSurfaceIndex[REGMALE][THROW_ITEM_CROUCHED] = RGMTHROW_CR;
  gubAnimSurfaceIndex[REGMALE][ROLL_PRONE_L] = RGMROLL_PR;
  gubAnimSurfaceIndex[REGMALE][ROLL_PRONE_R] = RGMROLL_PR;
  //***17.12.2008***
  gubAnimSurfaceIndex[REGMALE][SHOOT_ROCKET_CROUCHED] = RGMROCKET_CR;
  //***11.01.2011*** станковый пулемёт
  gubAnimSurfaceIndex[REGMALE][READY_HEAVY_MG] = RGM_HMG;
  gubAnimSurfaceIndex[REGMALE][AIM_HEAVY_MG] = RGM_HMG;
  gubAnimSurfaceIndex[REGMALE][SHOOT_HEAVY_MG] = RGM_HMG;
  gubAnimSurfaceIndex[REGMALE][END_HEAVY_MG] = RGM_HMG;
  gubAnimSurfaceIndex[REGMALE][BURST_HEAVY_MG] = RGM_HMG;
  ...
  //***07.12.2008*** две новые анимации
  gubAnimSurfaceIndex[BIGMALE][THROW_ITEM_CROUCHED] = BGMTHROW_CR;
  gubAnimSurfaceIndex[BIGMALE][ROLL_PRONE_L] = BGMROLL_PR;
  gubAnimSurfaceIndex[BIGMALE][ROLL_PRONE_R] = BGMROLL_PR;
  //***17.12.2008***
  gubAnimSurfaceIndex[BIGMALE][SHOOT_ROCKET_CROUCHED] = BGMROCKET_CR;
  //***11.01.2011*** станковый пулемёт
  gubAnimSurfaceIndex[BIGMALE][READY_HEAVY_MG] = BGM_HMG;
  gubAnimSurfaceIndex[BIGMALE][AIM_HEAVY_MG] = BGM_HMG;
  gubAnimSurfaceIndex[BIGMALE][SHOOT_HEAVY_MG] = BGM_HMG;
  gubAnimSurfaceIndex[BIGMALE][END_HEAVY_MG] = BGM_HMG;
  gubAnimSurfaceIndex[BIGMALE][BURST_HEAVY_MG] = BGM_HMG;
  ...
  //***07.12.2008*** две новые анимации
  gubAnimSurfaceIndex[STOCKYMALE][THROW_ITEM_CROUCHED] = RGMTHROW_CR;
  gubAnimSurfaceIndex[STOCKYMALE][ROLL_PRONE_L] = RGMROLL_PR;
  gubAnimSurfaceIndex[STOCKYMALE][ROLL_PRONE_R] = RGMROLL_PR;
  //***17.12.2008***
  gubAnimSurfaceIndex[STOCKYMALE][SHOOT_ROCKET_CROUCHED] = RGMROCKET_CR;
  //***11.01.2011*** станковый пулемёт
  gubAnimSurfaceIndex[STOCKYMALE][READY_HEAVY_MG] = RGM_HMG;
  gubAnimSurfaceIndex[STOCKYMALE][AIM_HEAVY_MG] = RGM_HMG;
  gubAnimSurfaceIndex[STOCKYMALE][SHOOT_HEAVY_MG] = RGM_HMG;
  gubAnimSurfaceIndex[STOCKYMALE][END_HEAVY_MG] = RGM_HMG;
  gubAnimSurfaceIndex[STOCKYMALE][BURST_HEAVY_MG] = RGM_HMG;
  ...
  //***07.12.2008*** две новые анимации
  gubAnimSurfaceIndex[REGFEMALE][THROW_ITEM_CROUCHED] = RGFTHROW_CR;
  gubAnimSurfaceIndex[REGFEMALE][ROLL_PRONE_L] = RGFROLL_PR;
  gubAnimSurfaceIndex[REGFEMALE][ROLL_PRONE_R] = RGFROLL_PR;
  //***17.12.2008***
  gubAnimSurfaceIndex[REGFEMALE][SHOOT_ROCKET_CROUCHED] = RGFROCKET_CR;
  //***11.01.2011*** станковый пулемёт
  gubAnimSurfaceIndex[REGFEMALE][READY_HEAVY_MG] = RGF_HMG;
  gubAnimSurfaceIndex[REGFEMALE][AIM_HEAVY_MG] = RGF_HMG;
  gubAnimSurfaceIndex[REGFEMALE][SHOOT_HEAVY_MG] = RGF_HMG;
  gubAnimSurfaceIndex[REGFEMALE][END_HEAVY_MG] = RGF_HMG;
  gubAnimSurfaceIndex[REGFEMALE][BURST_HEAVY_MG] = RGF_HMG;
...
BOOLEAN LoadAnimationStateInstructions() {
  int i, value, nstr = 0, cnt;
  FILE *f;
  char szBuf[BUFSIZE];

  if ((f = fopen(".\\binarydata\\ja2bin.txt", "r")) == NULL) return (FALSE);

  memset(gusAnimInst, 0, sizeof(gusAnimInst));
  ...
  while (!feof(f)) {
    ...
    //обработка строк скриптов анимации
    if (strcmp(szBuf, "ANIM") == 0) {
      if (fscanf(f, "%d", &nstr) <= 0) continue;
      if (nstr > NUMANIMATIONSTATES) continue;

      //обработка названия скрипта
      fgetc(f);  //пропускаем tab
      while (fgetc(f) != '\t' && !feof(f))
        ;

      //обработка кодов скрипта
      for (cnt = 0; cnt < MAX_FRAMES_PER_ANIM; cnt++) {
        if (fscanf(f, "%d", &value) > 0) gusAnimInst[nstr][cnt] = (UINT16)value;
      }
    }
  }
...
UINT16 LoadSoldierAnimationSurface(SOLDIERCLASS *pSoldier, UINT16 usAnimState) {
  ...
  if (usAnimSurface != INVALID_ANIMATION_SURFACE) {
    ...
    if (GetCachedAnimationSurface(pSoldier->ubID, &(pSoldier->AnimCache), usAnimSurface,
                                  pSoldier->usAnimState) == FALSE) {
...
UINT16 DetermineSoldierAnimationSurface(SOLDIERCLASS *pSoldier, UINT16 usAnimState) {
  ...
  if (usAnimSurface == INVALID_ANIMATION) {
    ...
    ScreenMsg(FONT_MCOLOR_RED, MSG_BETAVERSION,
              L"Invalid Animation File for Body %d, animation %S.", pSoldier->ubBodyType,
