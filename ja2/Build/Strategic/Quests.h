...
#define NUM_FACTS \
  500  // If you increase this number, add entries to the fact text list in QuestText.c
...
#define BOBBYR_SHIPPING_DEST_SECTOR_X 9          /// 13
#define BOBBYR_SHIPPING_DEST_SECTOR_Y MAP_ROW_H  // 2
