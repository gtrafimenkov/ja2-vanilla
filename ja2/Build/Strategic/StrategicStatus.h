...
typedef struct STRATEGIC_STATUS {
  ...
  UINT8 ubStandardArmyGunIndex[ARMY_GUN_LEVELS];   // type of gun in each group that Queen's army is
                                                   // using this game
  BOOLEAN fWeaponDroppedAlready[MAX_WEAPONS_old];  // flag that tracks whether this weapon type has
                                                   // been dropped before
