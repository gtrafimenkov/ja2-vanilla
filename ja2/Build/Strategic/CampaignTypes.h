...
// StrategicMap[] array Use SECTOR_INFO_TO_STRATEGIC_INDEX() macro to convert...
enum {
  SEC_A1,
  SEC_A2,
  SEC_A3,
...
// enemies will display on mapscreen until time is compressed.  When time is compressed, the flag is
// cleared, and a question mark is displayed to reflect that the player no longer knows.
