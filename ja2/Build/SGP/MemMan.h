...
// This is the most effective way to debug memory leaks.  Each memory leak will be recorded in a
// linked list containing a string referring to the location in code the memory was allocated in
// addition to the number of occurrences.  The shutdown code will report all unhandled memory with
...
#else
#ifdef _DEBUG
// This is another debug feature.  Not as sophistocated, but definately not the pig the extreme
// system is. This system reports all memory allocations/deallocations in the debug output.
