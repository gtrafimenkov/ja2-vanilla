...
void DisableQuickSound() { DSDisable(); }

void PlayQuickSound(INT16 sSound) { SoundPlayEffect((EFFECT)sSound); }
...
char szSoundEffects[NUM_SOUND_EFFECTS][255] = {
    "SHOOT1", "MISS1", "FALL1", "HIT1", "HIT2", "DOOROPEN1", "DOORCLOSE1", "BURST1", "ENDTURN"};
