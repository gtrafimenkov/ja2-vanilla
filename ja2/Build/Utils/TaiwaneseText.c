...
UINT16 TacticalStr[][MED_STRING_LENGTH] = {
    ...
    L"Key Ring Panel", L"You cannot do that with an EPC.", L"Spare Krott?", L"Out of weapon range",
    L"Miner", L"Vehicle can only travel between sectors", L"Can't autobandage right now",
