...
//***21.11.2007*** новые письма от Босса и Громова
#define KING_PIN_HOSTAGE_LETTER (BOBBY_R_MEDUNA_SHIPMENT + BOBBY_R_MEDUNA_SHIPMENT_LENGTH)
#define KING_PIN_HOSTAGE_LETTER_LENGTH 4

#define GROMOV_LETTER (KING_PIN_HOSTAGE_LETTER + KING_PIN_HOSTAGE_LETTER_LENGTH)
#define GROMOV_LETTER_LENGTH 3

#define GROMOV_LETTER2 (GROMOV_LETTER + GROMOV_LETTER_LENGTH)
#define GROMOV_LETTER2_LENGTH 2
//***25.10.2008*** новые письма про десант от RIS и БР
#define RIS_REPORT2 (GROMOV_LETTER2 + GROMOV_LETTER2_LENGTH)
#define RIS_REPORT2_LENGTH 10

#define BOBBY_R_INFO (RIS_REPORT2 + RIS_REPORT2_LENGTH)
#define BOBBY_R_INFO_LENGTH 21
