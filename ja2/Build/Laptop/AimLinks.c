...
BOOLEAN EnterAimLinks() {
  ...
  for (i = 0; i < AIM_LINK_NUM_LINKS; i++) {
    MSYS_DefineRegion(&gSelectedLinkRegion[i], giOffsW + AIM_LINK_BOBBY_LINK_X, giOffsH + usPosY,
                      giOffsW + AIM_LINK_BOBBY_LINK_X + AIM_LINK_LINK_WIDTH,
                      (UINT16)giOffsH + (usPosY + AIM_LINK_LINK_HEIGHT), MSYS_PRIORITY_HIGH,
...
void RenderAimLinks() {
  ...
  BltVideoObject(FRAME_BUFFER, hPixHandle, 0, giOffsW + AIM_LINK_BOBBY_LINK_X,
                 giOffsH + AIM_LINK_BOBBY_LINK_Y, VO_BLT_SRCTRANSPARENCY, NULL);

  GetVideoObject(&hPixHandle, guiFuneralLink);
  BltVideoObject(FRAME_BUFFER, hPixHandle, 0, giOffsW + AIM_LINK_FUNERAL_LINK_X,
                 giOffsH + AIM_LINK_FUNERAL_LINK_Y, VO_BLT_SRCTRANSPARENCY, NULL);
  ...
  BltVideoObject(FRAME_BUFFER, hPixHandle, 0, giOffsW + AIM_LINK_INSURANCE_LINK_X,
                 giOffsH + AIM_LINK_INSURANCE_LINK_Y, VO_BLT_SRCTRANSPARENCY, NULL);
  ...
  // Draw Link Title
  DrawTextToScreen(AimLinkText[AIM_LINK_TITLE], giOffsW + AIM_LINK_TITLE_X,
                   giOffsH + AIM_LINK_TITLE_Y, AIM_LINK_TITLE_WIDTH, AIM_LINK_TITLE_FONT,
                   AIM_LINK_TITLE_COLOR, FONT_MCOLOR_BLACK, FALSE, CENTER_JUSTIFIED);
