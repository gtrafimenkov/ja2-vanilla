...
void RenderProfileBackGround(void) {
  ...
  for (iCounter = 0; iCounter < 4; iCounter++) {
    ...
    BltVideoObject(
        ...
        giOffsW + LAPTOP_SCREEN_UL_X + 0 * CHAR_PROFILE_BACKGROUND_TILE_WIDTH,
        giOffsH + LAPTOP_SCREEN_WEB_UL_Y + iCounter * CHAR_PROFILE_BACKGROUND_TILE_HEIGHT,
        VO_BLT_SRCTRANSPARENCY, NULL);
    BltVideoObject(
        FRAME_BUFFER, hHandle, 0,
        giOffsW + LAPTOP_SCREEN_UL_X + 1 * CHAR_PROFILE_BACKGROUND_TILE_WIDTH,
        giOffsH + LAPTOP_SCREEN_WEB_UL_Y + iCounter * CHAR_PROFILE_BACKGROUND_TILE_HEIGHT,
        VO_BLT_SRCTRANSPARENCY, NULL);
    BltVideoObject(
        FRAME_BUFFER, hHandle, 0,
        giOffsW + LAPTOP_SCREEN_UL_X + 2 * CHAR_PROFILE_BACKGROUND_TILE_WIDTH,
        giOffsH + LAPTOP_SCREEN_WEB_UL_Y + iCounter * CHAR_PROFILE_BACKGROUND_TILE_HEIGHT,
        VO_BLT_SRCTRANSPARENCY, NULL);
    BltVideoObject(
        FRAME_BUFFER, hHandle, 0,
        giOffsW + LAPTOP_SCREEN_UL_X + 3 * CHAR_PROFILE_BACKGROUND_TILE_WIDTH,
        giOffsH + LAPTOP_SCREEN_WEB_UL_Y + iCounter * CHAR_PROFILE_BACKGROUND_TILE_HEIGHT,
        VO_BLT_SRCTRANSPARENCY, NULL);
  }
  ...
  InvalidateRegion(giOffsW + LAPTOP_SCREEN_UL_X, giOffsH + LAPTOP_SCREEN_WEB_UL_Y, giOffsW + 640,
                   giOffsH + 480);
...
void RenderAnalyse(INT16 sX, INT16 sY, INT8 bImageNumber) {
  ...
  // blt to sX, sY relative to upper left corner
  BltVideoObject(FRAME_BUFFER, hHandle, bImageNumber, giOffsW + LAPTOP_SCREEN_UL_X + sX,
                 giOffsH + LAPTOP_SCREEN_WEB_UL_Y + sY, VO_BLT_SRCTRANSPARENCY, NULL);
...
void RenderAttributeFrame(INT16 sX, INT16 sY) {
  ...
  for (iCounter = 0; iCounter < 10; iCounter++) {
    // blt to sX, sY relative to upper left corner
    BltVideoObject(FRAME_BUFFER, hHandle, 2, giOffsW + LAPTOP_SCREEN_UL_X + sX + 134,
                   giOffsH + LAPTOP_SCREEN_WEB_UL_Y + sY + sCurrentY, VO_BLT_SRCTRANSPARENCY, NULL);
    BltVideoObject(FRAME_BUFFER, hHandle, 1, giOffsW + LAPTOP_SCREEN_UL_X + sX,
                   giOffsH + LAPTOP_SCREEN_WEB_UL_Y + sY + sCurrentY, VO_BLT_SRCTRANSPARENCY, NULL);
    BltVideoObject(FRAME_BUFFER, hHandle, 3, giOffsW + LAPTOP_SCREEN_UL_X + sX + 368,
                   giOffsH + LAPTOP_SCREEN_WEB_UL_Y + sY + sCurrentY, VO_BLT_SRCTRANSPARENCY, NULL);

    sCurrentY += 20;
  }

  BltVideoObject(FRAME_BUFFER, hHandle, 4, giOffsW + LAPTOP_SCREEN_UL_X + sX,
                 giOffsH + LAPTOP_SCREEN_WEB_UL_Y + sY + sCurrentY, VO_BLT_SRCTRANSPARENCY, NULL);
...
void RenderAttributeFrameForIndex(INT16 sX, INT16 sY, INT32 iIndex) {
  ...
  InvalidateRegion(giOffsW + LAPTOP_SCREEN_UL_X + sX + 134,
                   giOffsH + LAPTOP_SCREEN_WEB_UL_Y + sY + sCurrentY,
                   giOffsW + LAPTOP_SCREEN_UL_X + sX + 400,
                   giOffsH + LAPTOP_SCREEN_WEB_UL_Y + sY + sCurrentY + 21);
