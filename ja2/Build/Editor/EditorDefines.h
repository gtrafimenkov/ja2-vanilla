...
// When in merc-inventory mode, this flag is set when the user wishes to get an item, which requires
// hooking into the item editing features.  It is defined here, so editoritems can get access to
// this mode which makes certain special cases.
extern BOOLEAN gfMercGetItem;

// When actually editing item statistics, this value will be set, for the purposes of rendering,
// input, etc.
