...
extern BOOLEAN EvaluateWorld( CHAR8 *pSector, UINT8 ubLevel );
extern void WriteSectorSummaryUpdate( CHAR8 *puiFilename, UINT8 ubLevel, SUMMARYFILE *pSummaryFileInfo );
